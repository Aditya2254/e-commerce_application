package com.aditya2254.ecommerceapp.userservice.util;
 ...
 * 
 * This class provides utility methods for working with JWT tokens, including:
 * - Extracting claims from tokens
 * - Generating tokens
 * - Validating tokens
 * - Handling the signing key
 * 
 * Note: This class provides similar functionality to JwtService. In a production
 * application, it would be better to consolidate JWT operations into a single service
